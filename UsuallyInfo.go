...
var (
	...
	LoginApi2        = "http://127.0.0.1:8001/api/login" //这个需要自己去部署
	LoginApi         = "http://127.0.0.1:8001/api/login"
	LoginApi3        = "http://127.0.0.1:8001/api/login"
	LoginApi4        = "http://127.0.0.1:8001/api/login"
